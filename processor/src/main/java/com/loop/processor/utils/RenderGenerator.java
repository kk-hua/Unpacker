...
public class RenderGenerator {
    ...
    public static String getRenderPackageName() {
        return RENDER_PACKAGE_NAME;
    }
...
//    }
    ...
    public TypeSpec getStudentClass() {
        return TypeSpec
                ...
                .addSuperinterface(ClassName.get(RENDER_PACKAGE_NAME, "Person"))
                .addModifiers(Modifier.PUBLIC)
                .addField(FieldSpec
...
//                .addMethod(getPrintNameMultipleTimesMethod())
    ...
    public void generateGenderEnum() throws IOException {
        writeToOutputFile(getRenderPackageName(), getGenderEnum());
    }

    public void generatePersonInterface() throws IOException {
        writeToOutputFile(getRenderPackageName(), getPersonInterface());
    }

    public void generateStudentClass() throws IOException {
        writeToOutputFile(getRenderPackageName(), getStudentClass());
    }
